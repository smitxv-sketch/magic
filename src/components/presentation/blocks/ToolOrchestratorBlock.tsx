...
import { Bot, Database, Calculator, Mail, FileText, ArrowRight, CheckCircle2, Server, Globe } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="relative h-[600px] w-full max-w-6xl mx-auto">
          ...
          <div className="absolute top-[15%] left-1/2 md:top-[25%] md:left-[15%] -translate-x-1/2 -translate-y-1/2 z-10 flex flex-col items-center w-full px-4 md:w-auto">
            <div className="bg-slate-800 p-4 md:p-6 rounded-2xl border border-slate-600 shadow-2xl w-full max-w-[280px] relative overflow-hidden group">
          ...
          <div className="absolute top-[65%] left-[20%] md:top-[20%] md:left-[80%] -translate-x-1/2 -translate-y-1/2 z-10 flex flex-col items-center">
            ...
            <span className="mt-2 md:mt-3 text-blue-400 text-xs md:text-sm font-bold uppercase tracking-wide">1С</span>
          </div>
          ...
          <div className="absolute top-[65%] left-[50%] md:top-[50%] md:left-[90%] -translate-x-1/2 -translate-y-1/2 z-10 flex flex-col items-center">
            ...
            <span className="mt-2 md:mt-3 text-amber-400 text-xs md:text-sm font-bold uppercase tracking-wide">Python</span>
          </div>
          ...
          <div className="absolute top-[65%] left-[80%] md:top-[80%] md:left-[80%] -translate-x-1/2 -translate-y-1/2 z-10 flex flex-col items-center">
            ...
            <span className="mt-2 md:mt-3 text-purple-400 text-xs md:text-sm font-bold uppercase tracking-wide">ФНС</span>
          </div>
          ...
          <div className="absolute top-[90%] left-1/2 md:top-[80%] md:left-[15%] -translate-x-1/2 -translate-y-1/2 z-10 flex flex-col items-center w-full px-4 md:w-auto">
            <div className={cn(
              "bg-slate-800 p-4 rounded-xl border shadow-lg w-full max-w-[220px] transition-all duration-500",
              step === 5 ? "border-emerald-500 shadow-emerald-500/20" : "border-slate-700 opacity-50"
            )}>
              <div className="flex items-center gap-2 mb-2 text-slate-400 text-xs uppercase tracking-wider font-bold">
                <CheckCircle2 className="w-3 h-3" /> Результат
              </div>
              <div className="space-y-2">
                <p className="text-sm text-slate-300">
                  {step === 5 ? "Ответ готов." : "Ожидание..."}
                </p>
                {step === 5 && (
                  <motion.div 
                  ...
                  >
                    <span className="text-[10px] bg-blue-500/20 text-blue-300 px-1.5 py-0.5 rounded border border-blue-500/30">Долг: 0₽</span>
                    <span className="text-[10px] bg-amber-500/20 text-amber-300 px-1.5 py-0.5 rounded border border-amber-500/30">Пени: 0₽</span>
                  </motion.div>
                )}
              </div>
            </div>
