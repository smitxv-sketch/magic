...
export const SolutionRoutingSection = ({ block }: { block: PresentationBlock }) => {
  ...
  return (
    <section className="py-32 px-6 relative overflow-hidden bg-slate-950">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
        ...
        >
          {block.badge && (
            <span className="inline-block px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-[0.15em] mb-6 border shadow-lg backdrop-blur-sm bg-emerald-950/50 text-emerald-400 border-emerald-800/50 shadow-[0_0_15px_rgba(16,185,129,0.1)]">
              {block.badge}
            </span>
          )}
          ...
          <div className="space-y-4">
            {block.content?.map((item, idx) => {
              ...
              return (
                ...
                >
                  <div className="p-3 rounded-xl shrink-0 transition-colors duration-300 bg-emerald-950/50 text-emerald-400 group-hover:bg-emerald-900/60">
        ...
        >
          ...
          <div className="absolute inset-0 blur-[80px] rounded-full transform scale-90 opacity-50 bg-emerald-500/20" />
